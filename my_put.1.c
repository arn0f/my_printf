...
* Last Change       : septembre 25th, 2015 at 14:55:14
 ...
 * Input: 
 * 	int nbr: integer to return string value
 ...
 * Input:
 * 	int ptr: pointer to return hexadecimal value
 ...
 * Input:
 * 	int nbr: integer to return hexadecimal value
 * 	int upper: 0 or 1, uppercase or lowercase
